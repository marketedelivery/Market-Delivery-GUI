...
public class ControladorCompararPreco{
	...
	/**
	 *  metodo recebe uma lista de item e retorna um lista produtos indisponiveis no supermercado bompreço
	 * @param listProd
	...
	/**
	 *  metodo recebe uma lista de item e retorna um lista produtos indisponiveis no supermercado carrefour
	 * @param listProd
	 * @return listaProdIndisnivel
	 */
	...
	/**
	 *  metodo recebe uma lista de item e retorna um lista produtos indisponiveis no supermercado extra
	 * @param listProd
	 * @return listaProdIndisnivel
	 */
	...
	/**
	 *  recebe a lista de item e retorna o valor total dos itens disponivel no supermercado
	 * @param lisItem
