...
public class EmailUtil {
	...
	public void enviarEmail(Usuario u) throws EmailException{
		String mensagem =  "<H4>Olá sr.(a) " + u.getNome() + "</H4>" +  
                "<BR>" +  
                "<P> Enviamo a nova senha de acesso ao marketedelivary</P>" +  
                "<BR>" +  
                "<P>A nova senha é: </P>" +  
                "<UL>" +  
                
                "<LI><B> - Senha: </B>" + u.getSenha() +  
                "</UL>" +  
                "<BR>" +  
                "<P> Att, </p>" +  
                "<BR>" +  
                "<P>Por favor não respoder este email."+
                "<BR>" +  
                 " att: "
                + "Equipe MartekeDelivery </P>" + 
                "<BR>" +
                "<BR> \n";  
